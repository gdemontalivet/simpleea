...
export type ChatMessage = Message | ExploreMessage | SummarizeMesage | DashboardMessage
...
export interface AvailableExplore {
  modelName: string
  exploreId: string
  exploreKey: string
  label?: string
...
export interface AssistantState {
  ...
  availableExplores: AvailableExplore[]
  query: string
  examples: {
...
export const assistantSlice = createSlice({
  ...
  reducers: {
    ...
    setExploreParams: (state, action: PayloadAction<ExploreParams>) => {
      ...
      // Overwrite model and view from LLM with the one from the state
      ...
      state.currentExploreThread.exploreParams = payload
    },
    updateCurrentThread: (
      state,
    ...
    setAvailableExplores: (state, action: PayloadAction<AvailableExplore[]>) => {
      state.availableExplores = action.payload
    },
